...
public class exercicio13 {
	...
	public static void main(String[] args) {
		/*
		 * Faça um programa que pergunte quanto você ganha por horar e o número de
		 * horas trabalhadas no mês Calcule e mostre o total do seu salário no
		 * referido mês, sabendo-se que são descontados 11% ara o Imposto de Renda, 8%
		 * para o INSS e 5% para o sindicado, faça um programa que nos dê: .salário
		 * bruto. a. quanto pagou ao INSS. b. quanto pagou ao sindicato. c. o salário
		 * líquido. d. calcule os descontos e o salario liquido, conforme a tabela +
